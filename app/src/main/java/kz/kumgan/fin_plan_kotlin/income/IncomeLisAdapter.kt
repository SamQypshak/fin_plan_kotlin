...
class IncomeLisAdapter constructor(private val list:List<IncomeModel>,
                                   val mItemClickListener:ItemClickListener): RecyclerView.Adapter<IncomeLisAdapter.ViewHolder>() {
